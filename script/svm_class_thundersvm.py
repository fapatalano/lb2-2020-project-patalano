...
class svc():
    ...
    def grid_search(self):
        ...
        joblib.dump(clf.cv_results_,'/home/fabiana/svm/project/test/cv_results.joblib')
        joblib.dump(clf.best_estimator_, '/home/fabiana/svm/project/test/best_estimator.joblib')
        joblib.dump(clf.best_score_, '/home/fabiana/svm/project/test/best_score.joblib')
